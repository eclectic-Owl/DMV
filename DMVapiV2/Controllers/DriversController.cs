...
namespace DMVapiV2.Controllers
{
    ...
    public class DriversController : ControllerBase
    {
        ...
        {
            if (id != driver.DriverSocialSecurity)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Driver>> PostDriver(Driver driver)
        {
          if (_context.Drivers == null)
          {
            ...
            {
                if (DriverExists(driver.DriverSocialSecurity))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetDriver", new { id = driver.DriverSocialSecurity }, driver);
        }
        ...
        {
            return (_context.Drivers?.Any(e => e.DriverSocialSecurity == id)).GetValueOrDefault();
        }
    }
}
